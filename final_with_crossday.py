...
def index_response_trans(city, response):
    result = {}
    ...
    try:
        ...
        print "Can't get the index date of city: " + cityID
    return result
...
def air_response_trans(city, response, allPara):
    result = {}
...
def insert_DB(content):
    try:
        ...
        forecast_sql = "INSERT INTO weather_info(" + keys[:-1].replace('\'', '') + ") VALUES (" + values[:-1] + ")" \
        ...
        if content.has_key('hourWeather') and content.has_key("observeTime"):
            observe_sql = "INSERT INTO weather_info(" + observe_keys + observe_sql_keys + ") VALUES (" \
        ...
        if content.has_key("airTime"):
            air_sql = "INSERT INTO weather_info(" + air_keys + air_sql_keys + ") VALUES (" + air_values + air_sql_values + ")" \
